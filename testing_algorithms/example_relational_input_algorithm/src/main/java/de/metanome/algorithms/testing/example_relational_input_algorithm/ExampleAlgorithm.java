  ...
  TableInputParameterAlgorithm
{
  ...
  public ArrayList<ConfigurationRequirement> getConfigurationRequirements() {
    ...
    ConfigurationRequirementRelationalInput requirementRelationalInput = new ConfigurationRequirementRelationalInput(
      RELATIONAL_INPUT_IDENTIFIER);
    ConfigurationRequirementTableInput requirementTableInput = new ConfigurationRequirementTableInput(
      TABLE_INPUT_IDENTIFIER);
